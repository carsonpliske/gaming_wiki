...
class QuincyAdams extends Component {
  componentDidMount() {
    this.props.changeHeader("Quincy Adams");
  }
  render() {
    return (
      <AboutWrapper>
        <Headline className={this.props.header}>John Quincy Adams</Headline>
        <Text>
          {" "}
