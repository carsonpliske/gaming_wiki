...
class H_Harrison extends Component {
  componentDidMount() {
    this.props.changeHeader("William H. Harrison");
  }
  render() {
    return (
      <AboutWrapper>
        <Headline className={this.props.header}>William H. Harrison</Headline>
        <Text>
          {" "}
