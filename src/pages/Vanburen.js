...
class Vanburen extends Component {
  componentDidMount() {
    this.props.changeHeader("Martin van Buren");
  }
  render() {
    return (
      <AboutWrapper>
        <Headline className={this.props.header}>Martin van Buren</Headline>
        <Text>
          {" "}
